      ...
      <div className="relative z-10 p-6 md:p-10">
        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto mt-10">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-lg rounded-xl p-6 md:p-10">
            <h2 className="text-3xl font-bold mb-6 text-center text-indigo-500">Admin Settings</h2>

            <div className="space-y-4">
              <div className="bg-gray-800 p-4 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold mb-2">Profile Settings</h3>
                <p className="text-gray-300 mb-4">Manage your profile settings.</p>
              ...
              <div className="bg-gray-800 p-4 rounded-lg shadow-lg">
                ...
                <p className="text-gray-300 mb-4">Manage your notification settings.</p>
                <button className="bg-blue-600 text-white py-2 px-4 rounded-lg text-lg transition-transform hover:scale-105 hover:bg-blue-500 shadow-lg">
                  Edit Notifications
                </button>
              </div>
